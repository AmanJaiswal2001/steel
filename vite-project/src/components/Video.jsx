...
<div className=" px-20  pt-20">
  <div className=" justify-between gap-5  flex flex-col-reverse   lg:flex lg:flex-row w-full">
    ...
    <div className='lg:w-1/2 flex flex-col gap-3 pt-5'>
      <p className="text-5xl  font-extrabold font-poppins uppercase text-[#2241a6] ">Your one stop solution   </p>
      <p className="text-5xl leading-16 font-extrabold font-poppins uppercase text-[#2241a6] ">for your industrial needs</p>
      <p className="font-medium text-2xl   font-poppins border-box">
