...
const Home = () => {
    ...
    <div className='w-full h-full '>
        <div className='w-full flex px-20 mb-20'>
            ...
            <div className='w-1/2'>
               {/*contents */}
               <p className='h-36 leading-[100%]  font-sans text-[44px] w-96 text-[#000000] font-bold'>Discover Our Commitment to Sustainability</p>
               <p className='font-sans font-normal text-[20px] text-[#000000] h-56 '>Founded in 2010, SteelEco has evolved into a leader in sustainable steel production. Our mission is to innovate while minimizing environmental impact, ensuring integrity and stewardship in every aspect of our operations.</p>
            </div>
            <div className='w-2/3'>
               {/* img */}
...
<div className='w-72 h-16 bg-[#1F2AA9] rounded-[10px] flex justify-center items-center cursor-pointer mt-2'>
    ...
    Learn More
        ...
        <div className=' flex px-20 gap-5 mb-20 '>
            ...
            <div className='w-1/2'>
                {/* img */}
                <div className='w-full h-[120px] bg-[#F30707]'>
<p className='font-sans font-semibold text-[48px] text-white mx-20 pt-2'>PRODUCTS</p>
                </div>
<div className='w-full relative'>
    <img className='w-full h-[450px]' src="/Maskg.png"/>
    <p className=' absolute top-20 left-5 text-white font-sans font-bold text-[48px] w-[452px] h-72'>A Wide Spectrum of Cold and Hot Finished Steel Products</p>
</div>
...
<p className='font-sans font-normal text-2xl'>ISO 14001 Certified</p>
</div>
<div className='flex gap-2 items-center '>
<svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 24 24"><path fill="currentColor" d="M12 22q-2.075 0-3.9-.788t-3.175-2.137T2.788 15.9T2 12t.788-3.9t2.137-3.175T8.1 2.788T12 2t3.9.788t3.175 2.137T21.213 8.1T22 12t-.788 3.9t-2.137 3.175t-3.175 2.138T12 22"/></svg>
<p className='font-sans font-normal text-2xl'>Ministry of Environment Compliant</p>
</div>
<div className='flex gap-2 items-center '>
<svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 24 24"><path fill="currentColor" d="M12 22q-2.075 0-3.9-.788t-3.175-2.137T2.788 15.9T2 12t.788-3.9t2.137-3.175T8.1 2.788T12 2t3.9.788t3.175 2.137T21.213 8.1T22 12t-.788 3.9t-2.137 3.175t-3.175 2.138T12 22"/></svg>
<p className='font-sans font-normal text-2xl'>Sustainable Manufacturing Processes</p>
</div>
</div>
...
<p className='w-[626px] h-28 font-semibold text-5xl text-white'>We Are Building Better Community</p>
             ...
             <div>
                <p className='font-bold font-sans text-6xl text-white'>47+</p>
             <p className='text-2xl font-sans font-normal text-white'>CRS projects</p>
              </div>
              <div>
                <p className='font-bold font-sans text-6xl text-white'>30+</p>
             <p className='text-2xl font-sans font-normal text-white'>CRS projects</p>
              </div>
             </div>
              <div className='flex gap-10'>
              <div >
                <p className='font-bold font-sans text-6xl text-white'>10+</p>
             <p className='text-2xl font-sans font-normal text-white'>CRS projects</p>
              </div>
              <div>
                <p className='font-bold font-sans text-6xl text-white'>7k+</p>
             <p className='text-2xl font-sans font-normal text-white'>CRS projects</p>
              </div>
