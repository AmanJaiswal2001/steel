...
const CardSheet= (
  ...
  return (
    <div className="card  bg-base-100 w-64 h-96  shadow-sm ">
    ...
    <div className="card-body m-0 p-0 ">
      ...
      <p className='px-2'><span className='font-semibold'>Length</span>{" "}{length}</p>
      <div className='bg-blue-100 rounded-b-lg w-full'>
      <div className="  w-80 m-0 p-0 text-left   ">
        <button className=" p-2 w-80 m-0  text-left bg-bl-200 ">{buttonName}</button>
      </div>
