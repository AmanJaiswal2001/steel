...
const CardSheet= (
  ...
  return (
    ...
    <div className="card-body m-0 p-0 -z-10">
      ...
      <p className='px-2 font-sans font-medium   text-[1rem]'><span className='font-semibold'>Length</span>{" "}{length}</p>
      ...
      <div className='flex gap-1 px-2 mb-2'>
        ...
        <span className='px-2 font-sans font-medium   text-[1rem]'>{delivery}  </span>
      </div>
      </div>
