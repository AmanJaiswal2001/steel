...
<div className="w-full mb-20">
  <div className="relative w-full lg:w-[90%] mx-auto px-5 mt-10">
    ...
    <button
      className={`absolute right-40 h-9 w-9 top-[40%] hidden lg:flex items-center justify-center bg-[#e6f0ff] bg-opacity-50 cursor-pointer text-[#2241a6] p-1 rounded-lg hover:bg-[#d7e7ff] ${currentIndex >= cardData.length - visibleCards ? "invisible" : "visible"}`}
      onClick={nextSlide}
