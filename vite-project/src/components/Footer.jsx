...
const Footer = () => {
  return (
    <div className='w-full lg:h-1/3 md:h-1/3 sm:h-1/3 h-full absolute border-0 bg-[#2241a6] lg:bg-none  border-b-0'>
<footer className="footer w-full  font-sans sm:footer-horizontal bg-[#2241a6]  p-10 h-full lg:h-80">
 ...
 <a className="link link-hover">    <FontAwesomeIcon className='text-white  w-6 h-6' icon={faSquareYoutube} size="2x" /></a>
  ...
  <nav>
    ...
    <a className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">Mild Steel</a>
    <a className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">Stainless Steel</a>
    <a className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">Structure Steel</a>
    <a className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">TMT</a>
    <a className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">Cement</a>
  </nav>
  <nav>
    <h3 className=" text-lg text-white font-semibold">Sonatek </h3>
    <a className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">About us</a>
    <a className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">Blogs</a>
    <a className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">Sitemap</a>
    <a className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">Sonatek</a>
  </nav>
  <nav>
    <h3 className=" text-lg text-white font-semibold">Policy </h3>
    <a className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">Terms& conditions</a>
    <a className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">Privacy policy</a>
    <a className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">Return policy</a>
  </nav>
  <nav>
   ...
   <span className="cursor-pointer text-white  hover:text-[#2241a6] font-light text-sm ">+91720805523</span>
   </a>
   ...
   <span className="cursor-pointer text-white hover:text-[#2241a6] font-light text-sm ">support@sonatek.com</span>
   </a>   
   <a className=" flex gap-2">
   ...
   <span className="cursor-pointer text-white  hover:text-[#2241a6] font-light text-sm ">Help&support</span>
   </a> 
