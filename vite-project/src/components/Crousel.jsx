  ...
  return (
    <div className="relative h-full    w-full mx-auto overflow-hidden ">
      ...
      <button 
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2  hidden lg:flex  lg:items-center  lg:justify-center cursor-pointer text-white p-4  z-20   transition-all duration-300"
      >
       <div className="   ">
