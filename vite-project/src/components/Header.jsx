  ...
  return (
   ...
   <div className="md:hidden ">
    ...
    <Link to="/">
        ...
        <div className='flex md:w-full max-w-xxl  mt-1 sm:mt-0 md:mt-0  md:justify-center md:h-10 h-9  md:mx-20 md:items-center'>
            {/* search  */}
...
<button onClick={handleSearch} className='flex w-20 font-medium cursor-pointer text-sm font-poppins items-center px-2   '>
   Search
</button>
</button>
</div>
        ...
        {/* <div className='flex gap-4  '>
            {/* user */}
            {/* <button className='text-xl text-[#2241a6] font-poppins cursor-pointer font-bold'>Login</button> */}
{/* <button className='text-xl text-[#2241a6] font-poppins cursor-pointer font-bold'>Register</button> */}
        {/* </div> */} 
    </div>
  )
}
