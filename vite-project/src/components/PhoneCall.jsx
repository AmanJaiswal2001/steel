...
const PhoneCall = () => {
    return (
      <div className="fixed  bottom-4 flex flex-col justify-center w-52 h-14 text-[16px] font-normal  bg-white font-sans text-white px-4 py-2 rounded-full shadow-xl z-50">
