...
const PhoneCall = () => {
    return (
      <div className="fixed right-4 md:bottom-4 bottom-20 flex flex-col justify-center w-52 h-14 text-[16px] font-normal  bg-white font-poppins text-white px-4 py-2 rounded-full shadow-2xl z-50">
