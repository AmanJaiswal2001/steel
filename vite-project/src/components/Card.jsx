...
const Card = (
  ...
  return (
    ...
    <div className="card-body -z-10 m-0 p-0 px-2 ">
      ...
      <p className=' font-poppins font-semibold text-[#70737a]  text-[12px]'> {brand}</p>
     
      </div>
      <div className='flex gap-2'>
      <span className='font-semibold text-sm font-poppins text-[#262626]'>Thickness</span>
      <p className=' font-medium text-sm font-poppins text-[#262626]'> {thickness}</p>
     
      </div>
      <div className='flex gap-2'>
      <span className='font-semibold text-sm font-poppins text-[#262626]'>Width </span>
      <p className=' font-medium text-sm font-poppins text-[#262626]'> {width}</p>
     
      </div>
      {/* <p className=' font-poppins font-medium   text-[1rem]'><span className='font-semibold'></span> </p> */}
      {/* <p className=' font-poppins font-medium   text-[1rem]'><span className='font-semibold'></span> </p> */}
      ...
      <div className='flex gap-1 pt-2 px-2 '>
        ...
        <span className='font-poppins font-medium text-[#262626]   text-sm'>{delivery}  </span>
      </div>
      </div>
