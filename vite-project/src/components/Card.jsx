...
const Card = (
  ...
  return (
    <div 
     data-theme="light" 
    className=" card gap-0 hover:shadow-2xl  hover:bg-transparent  hover:scale-[98%] transform transition  ease-in-out  duration-300   bg-base-100 w-64 h-96  shadow-sm">
    <figure>
    ...
    <div className="card-body -z-10 m-0 p-0 ">
      <h2 className=" px-2 mt-2 font-sans font-medium h-12  text-[1rem]">{title}</h2>
      <h5 className='px-2 font-sans font-medium   text-[1rem]'>{brand}</h5>
      <p className='px-2 font-sans font-medium   text-[1rem]'><span className='font-semibold'>Thickness</span> {thickness}</p>
      <p className='px-2 font-sans font-medium   text-[1rem]'><span className='font-semibold'>Width </span> {width}</p>
      <div className='bg-blue-100 rounded-b-lg w-full'>
      <div className="  w-52 m-0 p-0 text-left   ">
        <button className=" p-2 w-full m-0  text-left bg-bl-200 font-sans cursor-pointer font-medium   text-[1rem] ">{buttonName}</button>
      </div>
      ...
      <div className='flex gap-1 px-2 mb-2 '>
        ...
        <span className='font-sans font-medium   text-[1rem]'>{delivery}  </span>
      </div>
      </div>
