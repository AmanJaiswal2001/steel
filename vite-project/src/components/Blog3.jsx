...
const Blog3 = () => {
    ...
    return (
        <div>
            ...
            <img className='w-full h-[500px]' src="/blog3.jpg" />
    <div className='flex w-full '>
    <p className='absolute text-white top-[60%] left-20  font-extrabold flex  md:text-4xl  m-auto font-poppins'>Steel Description</p>
     <p className='absolute w-[60%] text-white top-[70%] left-20  font-semibold flex  md:text-xl  m-auto font-poppins'>Steel is an alloy primarily composed of iron and a small percentage of carbon, which enhances its strength and fracture resistance.</p>
    </div>
               </div>
